...
* Add the summer rainfall for decile 5


* **Baseline**
* Add Baseline_Est_Start_water (for decile 5) 25% of summer rainfall (sometimes called 'Estimated PAW1 April (mm)')
...
* Estimated yield potential baseline = 80% of Yield potential 


* **Frontier**
* Add Frontier_Est_Start_water (for decile 5) 30% of summer rainfall
...
* Estimated yield potential Frontier = 80% of Yield potential 
