...
* use this to calculate the rain from start of growing season to defined date
...
* If the data set doest allow you to choose so many dates (ie only goes up to 28th.
...
* first date     "2024-04-01"
* second date    "2024-05-28"
* third date     "2024-06-30"
* forth date     "2024-07-24"
* fifth date    "2024-08-30"
* sixth date     "2024-09-30"
* seventh date   "2024-10-24"
...
* If you want to change this modified the first line in the below code chunk
...
* use the daily_file_sum_rain as input file for a loop but only keep the final yld
* datafame with dates method and yld
