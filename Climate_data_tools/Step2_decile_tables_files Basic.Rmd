...
* The default is 1/11 (1st Nov) to 30/03 (30th March)
* If you want to change this modified the below code chunk.
...
df <- read.csv(paste0(path, "/Neater_file_", site_selected,  ".csv")) 
      ...
      mutate(
      season = case_when(
      start_end_GS_date == "start_summer" ~ "summer",
      TRUE ~ "other"))
...
summer_defined_as <- paste0(
  Day_start_summer_rainfall, "/", Month_start_summer_rainfall,
  " to ", Day_end_summer_rainfall, "/", Month_end_summer_rainfall)

paste("summer season: ", summer_defined_as)
